...
void DejaLibHeapActivity( void )
{
    ...
    // Although it is not required, you can also register "debug" variations
    // which accept source file name and line number parameters.  The DejaLib 
    // will prefer the debug version over the standard version.
