...
//==============================================================================
//
//  DEJA_WII_READY      - The DejaLib uses Nintendo's sockets library to 
//                        communicate with Deja Insight.  It is the 
//                        application's responsibility to include and initialize
//                        this library.  Once the sockets library has been
//                        successfully initialized, call DEJA_WII_READY to
//                        inform the DejaLib that it is safe to attempt to
//                        utilize sockets.
//
//                        Also, since there is currently no way on the Wii to 
//                        programmatically access the command line other than
//                        via the parameters to main, there are variations of
//                        DEJA_WII_READY which accept different forms of command
//                        line data.  Consult the documentation for details on
//                        command line options.
//                        
//==============================================================================

void DEJA_WII_READY     ( void );
void DEJA_WII_READY     ( const char* pCommandLine );
void DEJA_WII_READY     ( int argc, const char* argv[] );
